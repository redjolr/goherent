...
func TestHandleTick_AdvancesRunningPackageSpinner(t *testing.T) {
	Test(`
	Given that a PackageStartedEvent has occurred for "somePackage"
	And there is a terminal with height 7
	When a HandleTick occurs
	Then the running package's spinner advances to its next frame "🕑 somePackage".`, func(Expect expect.F) {
		packStartedEvts := makePackageStartedEvents("somePackage")
		// Given
		interactor, terminal, _ := setup(7)
		interactor.HandlePackageStartedEvent(packStartedEvts["somePackage"])
	...
	Given that a PackageStartedEvent has occurred for "somePackage"
	And there is a terminal with height 7
	When two HandleTicks occur
	Then the running package's spinner advances two frames "🕒 somePackage".`, func(Expect expect.F) {
		packStartedEvts := makePackageStartedEvents("somePackage")
		// Given
		interactor, terminal, _ := setup(7)
		interactor.HandlePackageStartedEvent(packStartedEvts["somePackage"])
	...
	"\n\nPackages: 1 passed, 1 total\nTests: 1 passed, 1 totalt1 := time.Now()
		...
		Expect(terminal.Text()).ToEqual(
			"\n\n📋 Tests summary:\n\n" +
				...
				"\n" + ansi_escape.BOLD + "Tests:" + ansi_escape.RESET_BOLD + "    " +
				ansi_escape.GREEN + "1 passed" + ansi_escape.COLOR_RESET + ", 1 total" + ansi_escape.DIM + " (100% passed)" + ansi_escape.COLOR_RESET +
	...
	"\n\nPackages: 1 failed, 1 total\nTests: 1 failed, 1 total\nTime: 1.200s"`, func(Expect expect.F) {
		...
		Expect(terminal.Text()).ToEqual(
			"\n\n📋 Tests summary:\n\n" +
				...
				"\n" + ansi_escape.BOLD + "Tests:" + ansi_escape.RESET_BOLD + "    " +
				ansi_escape.RED + "1 failed" + ansi_escape.COLOR_RESET + ", 1 total" + ansi_escape.DIM + " (0% passed)" + ansi_escape.COLOR_RESET +
				"\n" + ansi_escape.BOLD + "Time:" + ansi_escape.RESET_BOLD + "     1.200s\n" +
				"Ran all tests." +
				"\n\n🐢 1 slowest test:\n  " + ansi_escape.YELLOW + "(1.20s)" + ansi_escape.COLOR_RESET + " ParentTest/testName" + "\n\n",
		)
	...
	"\n\nPackages: 1 passed, 1 total\nTests: 1 skipped, 1 passed, 2 total\nTime: 1.200s`, func(Expect expect.F) {
		...
		Expect(terminal.Text()).ToEqual(
			"\n\n📋 Tests summary:\n\n" +
				...
				"\n" + ansi_escape.BOLD + "Tests:" + ansi_escape.RESET_BOLD + "    " +
				ansi_escape.YELLOW + "1 skipped" + ansi_escape.COLOR_RESET + ", " +
				ansi_escape.GREEN + "1 passed" + ansi_escape.COLOR_RESET + ", 2 total" + ansi_escape.DIM + " (50% passed)" + ansi_escape.COLOR_RESET +
				"\n" + ansi_escape.BOLD + "Time:" + ansi_escape.RESET_BOLD + "     1.200s\n" +
				"Ran all tests.\n" +
	...
	"\n\nPackages: 1 skipped\nTests: 1 skipped\nTime: 1.372s"`, func(Expect expect.F) {
		...
		Expect(terminal.Text()).ToEqual(
			"\n\n📋 Tests summary:\n\n" +
				...
				ansi_escape.GREEN + "4 passed" + ansi_escape.COLOR_RESET + ", 14 total" + ansi_escape.DIM + " (28% passed)" + ansi_escape.COLOR_RESET +
				"\n" + ansi_escape.BOLD + "Time:" + ansi_escape.RESET_BOLD + "     1.372s\n" +
				"Ran all tests." +
